...
description: >-
  These are the JS basics you should be familiar with before getting started
  with react
pubDate: 2021-05-10T08:08:45.000Z
categories:
  - frontend
tags:
  - javascript
...
- I recommend you to check these resources.
  1. [How Asynchronous code works in JS](/writings/15-async-code-in-js)
  2. [What are promises and how they work](/writings/14-promises-explained)
  3. [Async and Await](/writings/16-async-await)
