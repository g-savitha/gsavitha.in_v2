...
pubDate: 2021-05-12T00:00:10.000Z
categories:
  - frontend
  - backend
tags:
...
Checkout [Asynchronous Code in JavaScript](/writings/15-async-code-in-js)
...
If you have checked out [this post](/writings/15-async-code-in-js) you might be familiar with the Callback example we used.
...
Is there any other better way other than promises? Checkout [Async and Await](/writings/16-async-await)
