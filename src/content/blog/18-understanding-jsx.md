...
pubDate: 2021-05-19T07:17:25.000Z
categories:
  - frontend
tags:
  - javascript
...
Welcome to the 3rd article of the [Epic React Series](/writings/12-epic-react-intro) which is based on the workshop [EpicReact.dev](https://epicreact.dev/) by [Kent C. Dodds](https://kentcdodds.com/). If you haven't read the previous article of this series, I recommend you to go read it first before proceeding further.

1. [JS Fundamentals for React](/writings/13-js-fundamentals-for-react)
2. [Intro to Raw React APIs](/writings/17-intro-to-raw-react-apis)
