...
pubDate: 2023-03-25T08:44:58.000Z
categories:
  - frontend
  - backend
tags:
...
Welcome to the first part of the [JS Hard Parts: Demystified](/writings/19-js-hard-parts) series. In this post, we will delve into the concepts of callbacks, execution context, functions, and higher-order functions. So let's get started without any delay :rocket:
...
<img src="/images/blog-img/cm.jpeg" alt="copyAndMultiplyBy2" style={{ width: '400px', display: 'block', margin: '0 auto' }} />
...
<img src="/images/blog-img/cd.jpeg" alt="copyAndDivideBy2" style={{ width: '400px', display: 'block', margin: '0 auto' }} />
...
<img src="/images/blog-img/cm1.jpeg" alt="copyAndManipulate" style={{ width: '400px', display: 'block', margin: '0 auto' }} />


Interpreter executes this as follows:

<img src="/images/blog-img/cm2.jpeg" alt="copyAndManipulate" style={{ width: '400px', display: 'block', margin: '0 auto' }} />
